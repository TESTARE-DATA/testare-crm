...
const ATHLETIC: ExSeed[] = [
  ...
  { name: "Nordic Hamstring", domain: "atletico", category: "Prevenzione", muscleGroups: ["Catena posteriore"], description: "Eccentrico flessori, prevenzione lesioni.", durationMin: 10, equipment: ["Tappetini"], tags: ["prevenzione", "forza"] },
